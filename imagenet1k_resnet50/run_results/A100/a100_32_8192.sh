...
#SBATCH --job-name=resnet50_a100_32_8192
#SBATCH --output=logs/resnet50_a100_32_8192_%j.out
#SBATCH --error=logs/resnet50_a100_32_8192_%j.err
...
BATCH_SIZE=8192        # Total batch size 
LEARNING_RATE=3.2      # Initial learning rate
...
DATA_DIR=$PROJECT_DIR/imagenet_data_3
