...
#SBATCH --job-name=resnet50_a100_8_2048
#SBATCH --output=logs/resnet50_a100_8_2048_%j.out
#SBATCH --error=logs/resnet50_a100_8_2048_%j.err
...
BATCH_SIZE=2048        # Total batch size 
