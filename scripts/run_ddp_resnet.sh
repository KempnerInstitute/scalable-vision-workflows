...
#SBATCH --job-name=resnet50_a100_4_1024
#SBATCH --output=logs/resnet50_a100_4_1024_%j.out
#SBATCH --error=logs/resnet50_a100_4_1024_%j.err
#SBATCH --partition=             # <--- Partition name (e.g., kempner)
#SBATCH --account=               # <--- Account name (e.g., Sabatini_lab)
#SBATCH --nodes=1
...
#SBATCH --constraint=a100        # GPU type (e.g., a100, h100, etc.)
