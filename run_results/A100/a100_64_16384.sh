...
#SBATCH --job-name=resnet50_a100_64_16384
#SBATCH --output=logs/resnet50_a100_64_16384_%j.out
#SBATCH --error=logs/resnet50_a100_64_16384_%j.err
...
BATCH_SIZE=16384       # Total batch size 
