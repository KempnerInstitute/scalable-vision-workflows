...
#SBATCH --job-name=resnet50_a100_16_4096
#SBATCH --output=logs/resnet50_a100_16_4096_%j.out
#SBATCH --error=logs/resnet50_a100_16_4096_%j.err
...
LEARNING_RATE=1.6      # Initial learning rate
