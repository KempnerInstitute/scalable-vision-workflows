...
#SBATCH --job-name=resnet50_a100_2_512
#SBATCH --output=logs/resnet50_a100_2_512_%j.out
#SBATCH --error=logs/resnet50_a100_2_512_%j.err
#SBATCH --partition=kempner
#SBATCH --account=kempner_dev
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=2      # Number of processes (1 per GPU)
...
DATA_DIR=$PROJECT_DIR/imagenet_data_1
