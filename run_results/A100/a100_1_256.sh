...
#SBATCH --job-name=resnet50_a100_1_256
#SBATCH --output=logs/resnet50_a100_1_256_%j.out
#SBATCH --error=logs/resnet50_a100_1_256_%j.err
#SBATCH --partition=kempner
#SBATCH --account=kempner_dev
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1      # Number of processes (1 per GPU)
...
DATA_DIR=$PROJECT_DIR/imagenet_data
